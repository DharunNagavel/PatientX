  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-3">
        ...
        <button
          className={`lg:hidden p-2 rounded-lg ${isScrolled ? "text-white" : "text-black"}`}
      ...
      <div
        ref={mobileMenuRef}
        className={`lg:hidden px-4 overflow-hidden h-0 opacity-0 ${isScrolled ? "bg-blue-500 text-white" : "bg-white/30 backdrop-blur-md text-black"}`}
      >
