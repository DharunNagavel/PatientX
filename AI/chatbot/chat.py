...
class CompleteHealthBot:
    def __init__(self, gemini_api_key=None):
        ...
        self.knowledge_base = {
            "greetings": [
                "🤗 Hello! Welcome to HealthData Marketplace! I'm here to help you with secure health data sharing.",
                "😊 Hi there! So glad you're here! I help people earn income while contributing to medical research.",
                "👋 Welcome! I'm your friendly health data assistant. Ready to explore how you can make a difference?"
            ],
            "earnings": {
            ...
            "security": [
                "🔒 AI anonymization removes all personal identifiers",
                "⛓️ Blockchain ensures your consent is permanent",
                "🔐 Military-grade encryption protects your data",
                "👁️ Researchers only see patterns, never personal info"
            ],
            "process": [
    ...
    def _handle_welcome(self, message):
        ...
        if any(word in message for word in ["hi", "hello", "hey", "start", "hey"]):
            ...
            return """🤗 Hello there! Welcome to HealthData Marketplace!
...
💰 **Earning potential** - How much you can make
🔒 **Data security** - How we protect your privacy
🔄 **The process** - How everything works
📊 **Data types** - What kind of health data you can share
🚀 **Getting started** - How to begin

What's on your mind? 😊"""

        return "👋 Hi! I'm here to help with health data sharing. Type 'hello' to get started!"
    ...
    def _handle_main_discussion(self, message):
        ...
        if any(word in message for word in ["earn", "money", "income", "make money", "how much", "price"]):
            earnings_info = "\n".join([f"• {desc}" for desc in self.knowledge_base["earnings"].values()])
            return f"""💰 **Earning Potential:**

{earnings_info}

**Additional factors:**
• Rare conditions can earn more
• Continuous data earns monthly income
• Genetic data has high one-time value

Want more specific pricing for your situation?"""

        # Security questions
        elif any(word in message for word in ["safe", "secure", "privacy", "protect", "anonymous"]):
            security_info = "\n".join([f"• {point}" for point in self.knowledge_base["security"]])
            return f"""🔒 **Your Privacy is Protected:**
...
Ready to learn how to get started?"""
        ...
        # Data type questions
            ...
            return """📊 **Data Types We Accept:**

**Digital Health Data:**
• Fitness tracker data (steps, heart rate, sleep)
• Smartphone health app data
...
What type of health data do you have? I can give you specific info!"""
        ...
        # Getting started
            ...
            return """🚀 **Ready to Get Started? That's Awesome!**
...
**What you'll need:**
• Email address
• Health data sources (phone, apps, records)
• 10 minutes of time
...
Would you like the website link to get started now?"""
        ...
        # General questions
            ...
            return "🤔 That's a great question! Could you tell me a bit more about what you're looking for? I can help with earnings, security, the process, or getting started."

        # Default response for unclear messages
        else:
            return """😊 Thanks for your message! I want to make sure I help you with exactly what you need.
...
I'm here to help with whatever you need!"""
    ...
    def _handle_detailed_info(self, message):
        ...
        if any(word in message for word in ["yes", "ready", "start", "begin", "website", "link"]):
            return """🎉 **Excellent! Let's Get You Started!**
...
**Pro Tips:**
• Start with just one data type if you're unsure
• You can always add more data later
• Support is available 24/7 if you need help

**Welcome Bonus:** Use code **FRIEND100** for extra earnings! 🎁

You're about to start earning while helping medical research - how amazing is that? 🌟

Any questions before you get started?"""

        elif any(word in message for word in ["no", "not yet", "later", "wait"]):
            self.current_step = "main_discussion"
            return "😊 No problem at all! Take your time. I'll be here when you're ready. Is there anything else you'd like to know about in the meantime?"

        else:
            return "🚀 Ready to begin your journey? Just say 'yes' and I'll give you all the details to get started!"

    def _handle_fallback(self, message):
        """Handle any unexpected messages"""
        return """🤗 I want to make sure I'm helping you with what you need!

Could you tell me what brought you here today? I can help with:

• Understanding how much you can earn
• Learning how your data is protected
...
What would be most helpful for you right now? 😊"""
    ...
    def save_chatbot(self, filename="health_bot.pkl"):
        ...
        try:
            ...
            return f"✅ Chatbot saved to {filename}"
        except Exception as e:
    ...
    def load_chatbot(filename="health_bot.pkl"):
        ...
        try:
            ...
            return bot, "✅ Chatbot loaded successfully!"
        except FileNotFoundError:
            return None, "❌ No saved chatbot found"
        except Exception as e:
            return None, f"❌ Error loading: {e}"
...
def main():
    ...
    if bot is None:
        ...
        if GEMINI_API_KEY == "YOUR_GEMINI_API_KEY_HERE":
            print("ℹ️  No Gemini API key provided. Using built-in responses.")
            bot = CompleteHealthBot()
        else:
            bot = CompleteHealthBot(gemini_api_key=GEMINI_API_KEY)

    print("=" * 60)
    print("🤗 COMPLETE HEALTH DATA CHATBOT")
    print("=" * 60)
    print("💡 I can help with: Earnings • Security • Process • Getting Started")
    print("🔧 Type 'save' to save progress, 'quit' to exit")
    print("\n" + bot.chat("hello"))
    ...
    while True:
        try:
            ...
            if user_input.lower() in ['quit', 'exit', 'bye']:
                ...
                print(f"🤗 {save_msg}")
                print("Thanks for chatting! Visit HealthDataMarketplace.com to get started! 👋")
                break
                ...
                print(f"📊 Current step: {bot.current_step}")
                print(f"💬 Chat history: {len(bot.conversation_history)} messages")
                print(f"🤖 Using Gemini: {bot.use_gemini}")
                continue
